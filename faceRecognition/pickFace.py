...
import cv2
import time
from readImg import readAllImg
...
def readPicSaveFace(sourcePath,objectPath,*suffix):
    try:
        ...
        count = 1
        face_cascade = cv2.CascadeClassifier('D:\\applications\opencv2\opencv\sources\data\haarcascades\haarcascade_frontalface_alt.xml')
...
if __name__ == '__main__':
    readPicSaveFace('D:\sthself\ml\\faceRecognition\pictures\sourcedataset\\other','D:\sthself\ml\\faceRecognition\pictures\dataset\\other','.jpg','.JPG','png','PNG')