...
#建立一个基于CNN的人脸识别模型
class Model(object):
    FILE_PATH = "D:\sthself\ml/faceRecognition\modelfacerecognition.h5"   #模型进行存储和读取的地方
    ...
    def build_model(self):
        ...
        self.model.add(
            Conv2D(
                ...
                kernel_size=(5, 5),
                padding='same',
                #dim_ordering='th',  reomved by ethan
    ...
    def train_model(self):
        self.model.compile(
            ...
            loss='categorical_crossentropy',  #你可以选用squared_hinge作为loss看看哪个好  sparse_categorical_crossentropy
            metrics=['accuracy'])
...
if __name__ == '__main__':
    dataset = DataSet('D:\sthself\ml\\faceRecognition\pictures\dataset')
    model = Model()
